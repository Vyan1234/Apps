...
blackbutton.grid(row = 0, column = 8, pady = 10)
def pink():
    global color
...
def grey():
    global color
    color = 'gray49'
greybutton =  tk.Button(buttonframe, text = "GREY", command = grey, fg = "gray49", padx = 10)
greybutton.grid(row = 0, column = 9, pady = 10)
def brown():
    global color
    color = 'brown4'
brownbutton =  tk.Button(buttonframe, text = "BROWN", command = brown, fg = "brown4")
brownbutton.grid(row = 0, column = 7, pady = 10)
def erase():
    global color
    color = "white"
